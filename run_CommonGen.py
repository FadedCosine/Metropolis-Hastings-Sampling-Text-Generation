...
def main():
    ...
    parser.add_argument('--LM_model_file', type=str, default="~/pretrained_model/gpt2_model")
    parser.add_argument('--MLM_model_file', type=str, default="~/pretrained_model/bert-base-uncased")
